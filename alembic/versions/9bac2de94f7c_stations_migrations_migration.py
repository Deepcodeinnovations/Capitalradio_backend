...
Revision ID: 9bac2de94f7c
Revises: d3d4e79d2399
Create Date: 2025-06-01 10:07:44.095710
...
revision: str = '9bac2de94f7c'
down_revision: Union[str, None] = 'd3d4e79d2399'
...
def upgrade() -> None:
    ...
    sa.Column('content', sa.Text(length='longtext'), nullable=False),
